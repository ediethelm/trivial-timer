# Contributing to trivial-object-lock
...
Bugs don't like to be ignored! Should you find a bug, please report it using the [New Issue](https://gitlab.com/ediethelm/trivial-object-lock/issues/new "Report a new issue") functionality.
...
4. Open a [Merge Request](https://gitlab.com/ediethelm/trivial-object-lock/merge_requests/new "New Merge Request") with a good title and a clear description (again, it has to be clear, easy to follow and written in complete sentences)
